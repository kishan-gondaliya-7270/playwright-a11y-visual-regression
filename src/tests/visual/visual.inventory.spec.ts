...
test.describe('Visual Test: Inventory Page', () => {
  test('@visual should visually match the inventory page with masked product images', async ({
    loginPage,
    inventoryPage,
  }) => {
